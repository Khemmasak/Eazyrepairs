            ...
            <div class="row">
                <div class="col-12">
                    <div class="callout callout-info">
                        ...
                        หน้านี้จะแสดงตัวอย่างใบเสร็จรับเงิน
                    </div>
                    <div class="callout callout-info">
                        <h5><i class="fas fa-info"></i> โปรดระบุประเภทใบเสร็จรับเงินที่ต้องการปริ้น</h5>
                        <form action="invoice_receipt.php" method="GET">
                            <div class="row">
                                <div class="col">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row no-print">
                            ...
                            <div class="col-12">
                                <?php if($type_print == 3){?>
                                <a href="new_receipt.php?id_ser=<?php echo"$id_ser";?>&id_cus=<?php echo"$id_cus";?>&id_devi=<?php echo"$id_devi";?>&type_print=<?php echo "$type_print";?>"
